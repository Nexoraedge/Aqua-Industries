                ...
                <div className="section-header flex flex-col lg:flex-row lg:items-end justify-between mb-24 gap-12">
                    <div className="space-y-4 max-w-2xl text-left">
                        <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-brand-600 block">
                            Direct Bulk Supply Optimization
                        </span>
                        <h2 className="font-serif text-4xl sm:text-5xl font-light text-brand-950 tracking-tight leading-[1.15]">
                            Direct-from-Factory Supply Infrastructure
                        </h2>
                    </div>
                    <p className="text-sm text-slate-500 font-light leading-relaxed max-w-sm text-left lg:border-l lg:border-slate-200 lg:pl-8">
                        As a primary manufacturer, Aqua Stone Industries controls the full raw chemical formulation and automated packaging arrays to guarantee structural cohesion down to the site footprint.
                    </p>
                </div>

                {/* Technical Stats Grid */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 border-t border-l border-brand-100/60">
                    {stats.map((stat, i) => (
                        <div
                            key={i}
                        ...
                        >
                            ...
                            <div className="my-6 overflow-hidden">
                                <h3 className="stat-value font-serif text-4xl sm:text-5xl font-light text-brand-950 tracking-tighter transition-transform duration-300 group-hover:translate-x-1">
                                    {stat.value}
                                </h3>
                            </div>
